 ...
 */
bool CNavArea::IsEntirelyVisible( const Vector &eye, const edict_t *ignore ) const
{
	Vector corner;
	trace_t result;
 ...
 */
bool CNavArea::IsPartiallyVisible( const Vector &eye, const edict_t *ignore ) const
{
	Vector corner;
	trace_t result;
	CTraceFilterNoNPCsOrPlayer traceFilter( ignore == nullptr ? nullptr: ignore->GetIServerEntity(), COLLISION_GROUP_NONE );
	const float offset = 0.75f * HumanHeight;
