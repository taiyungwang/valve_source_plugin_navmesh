...
static ConCommand nav_generate( "p_nav_generate", CommandNavGenerate, "Generate a Navigation Mesh for the current map and save it to disk.", FCVAR_GAMEDLL | FCVAR_CHEAT );
...
{
	return new CNavArea(m_navPlace);
}
